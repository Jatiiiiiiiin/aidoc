    ...
    },
    {
      ...
      "content": {
        "nodes": [
          ...
          { "id": "api", "name": "Supabase API", "status": "idle", "description": "Receives the final structured JSON schema and persists it in the Supabase database." }
        ]
      }
    },
    {
...
// Note: This mock data is used for testing the documentation parser
// and to ensure components render correctly in the Next.js UI.
